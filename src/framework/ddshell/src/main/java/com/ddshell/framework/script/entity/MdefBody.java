...
@IdClass(MdefBodyPK.class)
@MappedSuperclass
public abstract class MdefBody {
	...
	@ManyToOne
	private MdefValueType valueType;
	...
	public MdefValueType getValueType() {
		return valueType;
	}

	public void setValueType(MdefValueType valueType) {
